...
public final class Dtos { private Dtos(){}
 ...
 public record SourceView(UUID documentId,String documentName,int pageNumber,UUID chunkId,String evidence,boolean handwritten,String sourceType){}
 ...
 public record MessageView(UUID id,String role,String content,java.time.Instant createdAt){}
}
